    ...
    <div className="main  ">
       ...
       <div className="container w-[85%]  mx-auto flex-col flex">
         ...
         <div className="text-white z-100 translate-y-[90%] flex flex-row mx-auto container w-[90%]  justify-between">
            {cost.map((cost, index) => (
                cost == 14.00 ? <div className=" text-black rounded font-bold text-sm text-center "> <p className="bg-white py-2">$ + {cost}</p> </div> : <div className="bg-white text-black text-[0.60rem] inline-flex flex-row text space-x-2 px-4 font-bold"><p>Nov</p><p>{cost}</p></div> 
            ))}
        </div>
                <img  className="w-[100%] h-[100%]"src={single_meeting} alt=""></img>
            </div>
            <div className="bg-white text-black">
                <div className=" border-b-[0.1px] border-[gey] container w-[90%] mx-auto  p-2">
                    <h1 className="font-bold font-sans text-xs">Online Teaching and Learning Tools</h1>
                    <p className="lead text-[0.60rem] text-[#1f272b]">Recreio dos Bandeirantes, Rio de Janeiro - RJ, 22795-008, Brazil</p>
                </div>
                <div className=" p-3 border-[gey] text-[0.50rem] mx-auto container w-[90%] border-b-[0.1px] border-[gey]">
                ...
                <div  className=" container  p-4 text-[0.50rem] w-[90%] border-b-[0.1px] border-[gey] mx-auto flex flex-row  md:space-y-0 md:space-x-2" >
                    <h1 className="font-bold font-sans text-[0.60rem]">Share:</h1>
                    <p className="md:translate-y-[0.9px] pb-2">Facebook, Twitter, Linkedin, Behance</p>
                </div>
            </div>
            <div className="text-center text-[0.55rem] mt-4">
                <button className="rounded-full bg-[#0dc434] px-9 text-white font-bold py-2 ">BACK TO MEETING LISTS</button>
            </div>
       </div>
       <div className="text-center text-[0.55rem] border-[grey] p-4 border-t-[0.1px] mt-[8%]">
